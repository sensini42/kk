...
col = ["\033[0m", "\033[1;41;31m", "\033[1;42;32m", "\033[1;43;33m", "\033[1;44;34m", "\033[1;47;37m"]
col2 = ["\033[0m", "\033[1;40;31m", "\033[1;40;32m", "\033[1;40;33m", "\033[1;40;34m", "\033[1;40;37m"]
...
def aff3tab(tab,tab2,tab3):
    "affichage des tableaux en couleur (avant après)"
    for (i,ii,iii) in zip(tab, tab2, tab3):
        for j in i:
            sys.stdout.write(pieces[j])
        sys.stdout.write(" -> ")
        for j in ii:
...
def swappePaire(tab, coupleCoord):
